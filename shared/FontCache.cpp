...
bool FontCache::TextFormatExists(gmpi::IMpUserInterfaceHost2* host, gmpi_gui::IMpGraphicsHost* guiHost, std::string style)
{
	Factory factory;
...
GmpiDrawing::TextFormat_readonly FontCache::GetTextFormat(gmpi::IMpUserInterfaceHost2* host, gmpi_gui::IMpGraphicsHost* guiHost, std::string style, FontMetadata** returnMetadata)
{
	...
	if (returnMetadata)
		*returnMetadata = fonts_.back().legacy_metadata.get();
